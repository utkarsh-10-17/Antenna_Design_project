...
'@ use template: wide band patch.cfg
...
With Brick
     ...
     .Material "Copper (annealed)" 
     .Xrange "-Wc/2", "Wc/2" 
     .Yrange "Y+b+a", "Y+b+a+Lc" 
     .Zrange "0", "0.035" 
     .Create
End With

'@ boolean subtract shapes: component1:S1, component1:c1

'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Solid.Subtract "component1:S1", "component1:c1"

'@ boolean subtract shapes: component1:patch, component1:S1

'[VERSION]2019.0|28.0.2|20180920[/VERSION]
Solid.Subtract "component1:patch", "component1:S1"
...
With Port
  ...
  .XrangeAdd "3.175*8.16", "3.175*8.16"
  .YrangeAdd "0", "0"
  .ZrangeAdd "3.175", "3.175*8.16"
  .Shield "PEC"
  .SingleEnded "False"
  .Create
End With
...
With Monitor 
     ...
     .SetSubvolume "-37", "37", "0", "67", "-3.21", "25.943" 
